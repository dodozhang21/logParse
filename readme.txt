PRINT UNIQUE INSTANCES OF:

DHCP Database Save Failures (critical) Text to match ---> DHCP_SNOOPING-4-AGENT_OPERATION_FAILED_N
>>> This output needs only one instance printed per unique device in the syslog report
